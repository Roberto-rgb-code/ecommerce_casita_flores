...
declare module 'lg-hash' {
  const lgHash: any;
  export default lgHash;
}
declare module 'lg-pager' {
  const lgPager: any;
  export default lgPager;
}
declare module 'lg-rotate' {
  const lgRotate: any;
  export default lgRotate;
}
declare module 'lg-share' {
  const lgShare: any;
  export default lgShare;
}
declare module 'lg-video' {
  const lgVideo: any;
  export default lgVideo;
}
...
declare module 'lightgallery/css/lg-fullscreen.css';
