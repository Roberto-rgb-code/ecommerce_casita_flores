...
export default async function Home() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-pink-50/30 to-white">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-shadow duration-300 border border-gray-100">
              <div className="text-center">
                ...
                <div className="font-semibold text-gray-900 text-lg">Teresa Maldonado</div>
                <div className="text-sm text-gray-500 mt-1">Cliente satisfecha</div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-shadow duration-300 border border-gray-100">
              <div className="text-center">
                ...
                <div className="font-semibold text-gray-900 text-lg">Rosario Cervantes</div>
                <div className="text-sm text-gray-500 mt-1">Cliente satisfecha</div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-shadow duration-300 border border-gray-100">
              <div className="text-center">
                ...
                <div className="font-semibold text-gray-900 text-lg">Andrea Montes</div>
                <div className="text-sm text-gray-500 mt-1">Cliente satisfecha</div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-shadow duration-300 border border-gray-100">
              <div className="text-center">
                ...
                <div className="font-semibold text-gray-900 text-lg">Esteban Becker</div>
                <div className="text-sm text-gray-500 mt-1">Cliente satisfecho</div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-shadow duration-300 border border-gray-100">
              <div className="text-center">
                ...
                <div className="font-semibold text-gray-900 text-lg">Gonzalo y Sofía M.</div>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-shadow duration-300 border border-gray-100">
              <div className="text-center">
                ...
                <div className="font-semibold text-gray-900 text-lg">Mónica Ibáñez</div>
                <div className="text-sm text-gray-500 mt-1">Cliente satisfecha</div>
              </div>
            </div>
          </div>
      ...
      {/* INSTAGRAM SECTION - Mejorada */}
      <section className="py-20 md:py-24 bg-gradient-to-br from-pink-50 to-purple-50">
        <div className="container-max">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-light text-gray-900 mb-4">
              Creamos momentos <span className="font-serif italic text-[var(--brand)]">inolvidables</span> 🤍
            </h2>
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Síguenos en Instagram para ver nuestros arreglos más hermosos
            </p>
            <a 
              href="https://instagram.com/lacasitadlasflores" 
              target="_blank" 
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 mt-6 text-[var(--brand)] hover:text-pink-600 transition-colors font-medium"
            >
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {products.slice(0, 4).map((product, i) => (
              <a
                ...
                className="relative aspect-square rounded-2xl overflow-hidden group cursor-pointer shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-2"
              ...
              >
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-black/60 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                  <div className="absolute bottom-4 left-4 right-4 text-center text-white">
                    ...
                    <div className="text-xs opacity-90 mt-1">Ver producto</div>
                  </div>
                </div>
              </a>
            ))}
